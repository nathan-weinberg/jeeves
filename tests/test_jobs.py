...
def test_get_osp_version():
	...
	assert get_osp_version('DFG-hardware_provisioning-rqci-16_director-rhel-8.1-spineleaf-provision-network-20191605-2117') == '16'
	...
	assert get_osp_version('DFG-upgrades-updates-from-osp13.0-to-osp16.2-passed_phase1-HA-ipv4') == '16.2'
